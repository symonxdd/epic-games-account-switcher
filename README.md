...
Just choose the latest `.exe` file from the Releases section, or click [here](https://github.com/symonxdd/epic-games-account-switcher/releases/latest/download/EpicSwitcherSetup-0.0.1.exe)
